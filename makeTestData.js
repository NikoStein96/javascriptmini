...
async function createUsers() {
  ...
  var posPromises = [
    positionCreator(56, 56, users[0]._id),
    positionCreator(58, 58, users[1]._id),
    positionCreator(58, 58, users[2]._id),
    positionCreator(58, 58, users[3]._id),
    positionCreator(58, 58, users[4]._id)
  ];
